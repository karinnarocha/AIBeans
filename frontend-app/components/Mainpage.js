...
const culinaryOptions = [
  { label: 'Amateur', prompt: "I do not have a lot of experience cooking, give me a not a complicaded recipe..." },
        ...
        <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
          <View style={styles.borderContainer}>
            ...
            <Text style={styles.description}>Provide me the ingredients that you want to use:</Text>
              ...
              <View>
                <Text style={[styles.textAlign, styles.culinaryLevelTitle]}>Culinary Level:</Text>
